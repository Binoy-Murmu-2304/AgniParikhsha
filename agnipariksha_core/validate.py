"""
AgniPariksha Core - Step 6: Leave-One-Lot-Out Cross Validation Pipeline (Fast Version)
"""
import os
import glob
import numpy as np
...
def evaluate_leave_one_lot_out() -> pd.DataFrame:
    ...
    for test_lot in lot_names:
        ...
        agnipariksha_chamber_hours = (green_cnt * 24) + (red_cnt * 24) + (yellow_cnt * 72)
        hours_saved_pct = ((baseline_chamber_hours - agnipariksha_chamber_hours) / baseline_chamber_hours) * 100.0
