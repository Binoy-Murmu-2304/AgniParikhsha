"""
AgniPariksha 2.0 — STDF (Standard Test Data Format v4) & ATE Adapter
===================================================================
...
class ATEDataFormatConverter:
    """Converts ISRO ATE Datalogs (CSV / STDF stream) into AgniPariksha Input Schema."""
...
if __name__ == "__main__":
    print("=== AGNI_PARIKSHA STDF v4 ADAPTER TEST ===")
