"""
AgniPariksha 2.4 — Mixed-Signal IC Feature Engineer
==================================================
Domain-specific feature contract for Mixed-Signal IC devices (analog/digital interactions).
"""
...
class MixedSignalFeatureEngineer(BaseFeatureEngineer):
    """Engineered feature contract for MIXED_SIGNAL_IC devices."""
    ...
    def extract_features(
        ...
        # Analog-digital interaction indicator [SA]
        ad_interaction = v24 / np.maximum(1e-3, np.abs(v_off_24) + 1.0)
