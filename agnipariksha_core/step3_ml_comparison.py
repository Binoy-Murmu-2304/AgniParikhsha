"""
AgniPariksha Prototype - Step 3: ML Model Comparison (Linear vs. Random Forest vs. XGBoost)
...
def run_ml_regressor_comparison():
    print("========================================================================================")
    print("        AGNI_PARIKSHA PROTOTYPE - STEP 3: ML MODEL COMPARISON (168H FORECASTING)")
    print("========================================================================================\n")
    
    files = sorted(glob.glob("D:\\SIH 2026\\agnipariksha_core\\data\\LOT_*.csv"))
