"""
AgniPariksha 2.3 — Safety-Aware Model Router
============================================
...
class AgniParikshaModelRouter:
    """
    Context-aware model router for AgniPariksha 2.3.
    Ensures correct model selection and interlocks execution if context is ambiguous or unknown.
    """

    def __init__(self):
        self.default_predictor = AgniParikshaPredictorFast()
