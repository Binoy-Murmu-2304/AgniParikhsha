"""
AgniPariksha 2.0 ATE SDK Client Module
...
class AgniParikshaATESDK:
    ...
    def stream_ate_measurements(self, df_components: pd.DataFrame, interval_sec: float = 0.5) -> Generator[Dict[str, Any], None, None]:
        """Streams ATE measurement events to AgniPariksha API mimicking live chamber testing."""
...
if __name__ == "__main__":
    import pandas as pd
    print("=== AGNI_PARIKSHA ATE SDK STREAMING DEMO ===")
    test_df = pd.read_csv("D:\\SIH 2026\\agnipariksha_core\\data\\LOT_2026_07.csv").head(5)
    
    sdk = AgniParikshaATESDK(base_url="http://127.0.0.1:8000", instrument_id="ISRO_ATE_01", lot_id="LOT_2026_07")
    
    print(f"Connecting to AgniPariksha Engine at {sdk.base_url}...")
