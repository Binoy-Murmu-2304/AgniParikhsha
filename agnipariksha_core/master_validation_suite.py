"""
AgniPariksha 2.0 - Complete Master Validation Suite
...
from src.agnipariksha_lifecycle_engine import AgniParikshaLifecycleEngine

def run_master_validation_suite():
    print("========================================================================================")
    print("                AGNI_PARIKSHA 2.0: MASTER VALIDATION SUITE EXECUTION")
    print("========================================================================================\n")
    ...
    if not all_files:
        all_files = glob.glob("D:\\SIH 2026\\agnipariksha_core\\data\\LOT_*.csv")
    if not all_files:
    ...
    lifecycle_engine = AgniParikshaLifecycleEngine(static_limit_168h=45.0)
    ...
    print(f"AgniPariksha 🟡 Yellow Warning Triggered  : Mission Day {warning_day}")
    print(f"AgniPariksha 🔴 Red Critical FDIR Trigger : Mission Day {critical_day}")
