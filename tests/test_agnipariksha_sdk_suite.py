"""
AgniPariksha 2.4 — Safe ATE Integration SDK Test Suite
=====================================================
...
from agnipariksha_sdk.schema import SDKMeasurementRecord
from agnipariksha_sdk.ate_simulator import NonInvasiveATESimulator


class TestAgniParikshaSDKSuite(unittest.TestCase):

    def setUp(self):
        from agnipariksha_core.context_resolver import profiles as p
        p.ProfileRegistry._instance = None
        self.client = AgniParikshaClient(operator_id="TEST_QA_OPERATOR")
