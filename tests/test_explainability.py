"""
AgniPariksha 2.4 — Explainability Test Suite
===========================================
...
from agnipariksha_core.module_b import module_b_registry
from training.matrix_builder import TrainingMatrixBuilder
from agnipariksha_core.explainability import (
...
class TestExplainability(unittest.TestCase):
    ...
    def test_shap_and_physics_mapping(self):
        ...
        print("[PASS] Explainability Test Passed")
