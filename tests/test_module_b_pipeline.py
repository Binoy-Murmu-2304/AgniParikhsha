"""
AgniPariksha 2.4 — Module B Pipeline Test Suite
==============================================
...
from agnipariksha_core.module_b import ModuleBEvaluator, ModuleBTrainer, module_b_registry
...
class TestModuleBPipeline(unittest.TestCase):
    ...
    def test_evaluator_metrics(self):
        ...
        print("[PASS] ModuleBEvaluator test passed")
    ...
    def test_end_to_end_training_and_registry(self):
        ...
        print("[PASS] ModuleBTrainer and Registry integration test passed")
