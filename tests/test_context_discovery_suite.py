"""
AgniPariksha 2.2 — Context Discovery & Instrument QA Test Suite
...
from agnipariksha_core.context_resolver.profiles import ProfileRegistry
...
from agnipariksha_core.instrument_qa.health_model import InstrumentHealthModel
...
class TestContextDiscoverySuite(unittest.TestCase):
    ...
    def setUp(self):
        from agnipariksha_core.context_resolver import profiles as p
