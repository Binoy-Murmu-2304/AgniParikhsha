"""
AgniPariksha 2.0 — Comprehensive End-to-End System Test Suite
============================================================
Verifies:
...
from agnipariksha_sdk.schema import SDKAnalysisResult

class TestAgniParikshaSystem(unittest.TestCase):

    def setUp(self):
        self.client = AgniParikshaClient(operator_id="TEST_SYSTEM_OP")
    ...
    def test_05_explainability_and_auditability(self):
        ...
        res = self.client.analyze(df_valid)
        self.assertEqual(res.session.system_version, "AgniPariksha-2.4")
