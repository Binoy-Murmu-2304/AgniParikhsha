"""
AgniPariksha 2.0 — Milestone 2 & 9: Real-Time ATE Chamber Simulator & Failure Injector
====================================================================================
Simulates an active ATE burn-in chamber streaming raw measurements to AgniPariksha SDK.
...
class ATEChamberSimulator:
    def __init__(self, sdk: AgniParikshaATESDK):
        self.sdk = sdk
...
if __name__ == "__main__":
    sdk = AgniParikshaATESDK(base_url="http://127.0.0.1:8000", instrument_id="ISRO_CHAMBER_SEC_04")
    if not sdk.check_connection():
        print("❌ AgniPariksha Backend Server is not running! Start server.py on port 8000.")
        sys.exit(1)

    simulator = ATEChamberSimulator(sdk)
    csv_file = "D:\\SIH 2026\\agnipariksha_core\\data\\LOT_2026_07.csv"
