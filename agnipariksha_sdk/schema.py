"""
AgniPariksha 2.3/2.4 SDK — Canonical Measurement Schema & Data Structures
========================================================================
...
class AnalysisSessionMetadata(BaseModel):
    """Traceability & Audit Metadata for an AgniPariksha SDK analysis session."""
    ...
    system_version: str = "AgniPariksha-2.4"
...
class SDKAnalysisResult(BaseModel):
    """Structured end-to-end output returned by AgniPariksha Client."""
