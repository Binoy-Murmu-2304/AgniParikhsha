"""
AgniPariksha 2.4 — Main Read-Only Python SDK Client
=================================================
...
from agnipariksha_sdk.schema import (
    SDKMeasurementRecord,
    AnalysisSessionMetadata,
    SDKAnalysisResult,
)
from agnipariksha_sdk.adapters import CSVATEAdapter, JSONATEAdapter
from agnipariksha_sdk.integrity import DataIntegrityValidator
from agnipariksha_sdk.policy import AgniParikshaPolicyEngine
from agnipariksha_sdk.audit import AgniParikshaAuditLogger

from agnipariksha_core.context_resolver.explicit_parser import ExplicitMetadataParser
from agnipariksha_core.context_resolver.behavioral_infer import BehavioralInferenceEngine
from agnipariksha_core.context_resolver.schema import (
    TestContext, DeviceMetadata, TestMetadata, MeasurementRecord
)
from agnipariksha_core.model_router import AgniParikshaModelRouter


class AgniParikshaClient:
    """
    AgniPariksha Safe ATE Integration Client.
    Guarantees 100% read-only, non-invasive, auditable analytics.
    """

    def __init__(self, operator_id: str = "QA_OPERATOR_DEFAULT"):
        from agnipariksha_core.context_resolver import profiles as _p
        ...
        self.model_router = AgniParikshaModelRouter()
        self.policy_engine = AgniParikshaPolicyEngine()
        self.audit_logger = AgniParikshaAuditLogger()
