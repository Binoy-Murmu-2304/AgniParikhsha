"""
AgniPariksha 2.1 — ASQD Generator (Phase 1 + Phase 2: Provenance)
================================================================
Implements the three locked architectural principles:
  1. ASQD is explicitly synthetic — NOT ISRO data.
  2. AgniPariksha recommends; QA/qualification authority decides.
...
DATASET_NAME = "AgniPariksha Synthetic Qualification Dataset (ASQD)"
DATASET_NOTE = (
...
def generate_lot(
    ...
    provenance = {
        ...
        "observation_note":   (
            "168h is the AgniPariksha prototype observation horizon. "
...
if __name__ == "__main__":
    print("=" * 60)
    print("AgniPariksha 2.1 — ASQD Generator")
    print("=" * 60)
    generate_all_lots(
        output_dir="D:\\SIH 2026\\agnipariksha_core\\data",
        lots_config=[
