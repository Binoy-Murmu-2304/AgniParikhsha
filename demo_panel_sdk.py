"""
Panel Demonstration Script: Testing AgniPariksha SDK Installation & Stream
========================================================================
Run this script to prove SDK installation, connectivity, and real-time streaming to the panel.
"""

from agnipariksha_sdk import AgniParikshaATESDK

def main():
    print("=================================================================")
    print("   AGNI_PARIKSHA 2.0 SDK LIVE PANEL DEMONSTRATION                   ")
    print("=================================================================")
    
    # 1. Initialize SDK client
    sdk = AgniParikshaATESDK(base_url="http://127.0.0.1:8000", instrument_id="ISRO_ATE_DEMO_01")
    
    # 2. Test Connection
    print("\n[Step 1] Checking active connection to AgniPariksha backend server...")
    if not sdk.check_connection():
        print("❌ Error: Cannot connect to AgniPariksha backend server at http://127.0.0.1:8000!")
        print("   Please start the backend server first by running: python server.py")
        return
    print("✅ Success: Connection established with AgniPariksha Engine.")

    # 3. Stream Sample Lot Components via SDK
    csv_path = "D:\\SIH 2026\\agnipariksha_core\\data\\LOT_2026_07.csv"
    print(f"\n[Step 2] Ingesting ATE Lot Data line-by-line using AgniPariksha SDK...")
